...
int main(int argc, char const *argv[]) {
  ...
  publisher<bool> spin_stab_pub("SPIN_STAB", argv[0]);
  publisher<bool> sun_point_pub("SUN_POINT", argv[0]);
  publisher<bool> dark_side_pub("DARK_SIDE", argv[0]);
  publisher<ACS_DATA_BLOCK> acs_pub("ACS_DATA", argv[0]);
  ...
  TSL2561 light_sensor_1(0x01);
  TSL2561 light_sensor_2(0x02);
  TSL2561 light_sensor_3(0x03);
  TSL2561 light_sensor_4(0x04);
  TSL2561 light_sensor_5(0x05);
  TSL2561 light_sensor_6(0x06);
  TSL2561 light_sensor_7(0x07);
  TSL2561 light_sensor_8(0x08);
  ...
  while (true) {
    ...
    publisher_data.mag_field = sensor.magnetometer.read();
    publisher_data.gyro_data = sensor.gyroscope.read();
